...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String DOMAIN_URI_PREFIX = "https://xbt.lfdlast01cn.hwcloudtest.cn";
    private static final String DEEP_LINK = "https://page.xiaobingtang.cn/detail?id=123";
//    private static final String DEEP_LINK = "https://page.xiaobingtang.cn/setting?id=456";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.shareLong).setOnClickListener(view -> {
            shareLink((String) longTextView.getText());
        });

        AGConnectAppLinking.getInstance().getAppLinking(getIntent()).addOnSuccessListener(resolvedLinkData -> {
            Uri deepLink = null;
            ...
            Log.w("", "getAppLinking:onFailure", e);
        });
    }
    ...
    private void createAppLinking() {
        AppLinking.Builder builder = new AppLinking.Builder().setUriPrefix(DOMAIN_URI_PREFIX)
                ...
                .setAndroidLinkInfo(
                        new AppLinking.AndroidLinkInfo.Builder().build());
        builder.buildShortAppLinking(ShortAppLinking.LENGTH.SHORT).addOnSuccessListener(new OnSuccessListener<ShortAppLinking>() {
            @Override
