...
4. Select Project Settings, copy the SDK Code Snippet json from AppGallery Connect and paste the json to [index.ts](./pages/index/index.ts) in this demo.
...
6. Run the following code in terminal in the demo path, and run the demo.
    ``` bash
