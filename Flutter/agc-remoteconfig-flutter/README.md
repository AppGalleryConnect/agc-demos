# AppGallery Connect Remote Config Kit Flutter Plugin - Demo
...
This demo project is an example to demonstrate the features of the **AppGallery Connect Flutter Remote Config Kit
** Plugin.
...
**Step 1.** Set an unique **Application ID** on the app level build gradle file located on **example/android/app/build.gradle**. You should also change the **package names** for the manifest files in the **/example/android/app/src/** directory and on the **MainActivity.java** to match with the Application ID. 
  ...
  <!-- Other configurations ... -->
    defaultConfig {
      ...
      applicationId "<Enter_your_package_name_here>" // For ex: "com.developer.remoteconfig"
      minSdkVersion 17
      <!-- Other configurations ... -->
  }
  ```
...
### Enabling Remote Config Service

1. In [AppGallery Connect](https://developer.huawei.com/consumer/en/service/josp/agc/index.html), find your project, and click the app for which you want to use remote config.

2. Select **Grow** and **Remote Configuration** on the left menu and click **Enable Remote Configuration service**.
...
[Enabling RemoteConfig Service](https://developer.huawei.com/consumer/en/doc/development/AppGallery-connect-Guides/agc-remoteconfig-getstarted)

## 4. Licensing and Terms

AppGallery Connect Remote Config Kit Flutter Plugin Demo is licensed under [Apache 2.0 license](../LICENSE)
